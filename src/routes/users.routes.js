...
import { getUsers, createNewUser, setPremium } from '../controllers/user.controller.js'
import { Roles, checkSessionRole } from '../config/middlewares.js';

const routerUser = Router()

routerUser.get("/", getUsers)
routerUser.put("/premium/:uid", checkSessionRole(Roles.ADMIN), setPremium)
